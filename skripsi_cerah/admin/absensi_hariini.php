  ...
  <table class="w3-table w3-striped w3-small w3-hoverable w3-bordered w3-border" id="hendra7" style="margin-top:8px;">
    ...
    <?php do { ?>
      <tr class="item7">
        ...
        <td><a class="w3-tag w3-small w3-blue" style="text-decoration:none" href="absensi_update.php?id_absensi=<?php echo $row_rsAbsensiHariIni['id_absensi']; ?>">Ubah</a> <a class="w3-tag w3-small w3-red" style="text-decoration:none" onClick="return confirm('Anda Yakin Ingin Menghapus?')" href="absensi_delete.php?id_absensi=<?php echo $row_rsAbsensiHariIni['id_absensi']; ?>">Hapus</a></td>
      </tr>
