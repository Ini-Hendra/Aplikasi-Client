...
<div class="w3-container w3-light-gray">
  ...
  <a href="<?php echo $logoutAction ?>" onClick="return confirm('Anda Yakin Ingin Keluar?')" style="text-decoration:none"><li><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
   ...
   <br>
<div class="w3-center"><strong>USERNAME SUDAH DIGUNAKAN</strong><br>
SILAHKAN GUNAKAN USERNAME YANG LAIN<br>
<br>
<a onClick="window.historyback()" class="w3-btn w3-round-large w3-red"><i class="fa fa-chevron-left fa-fw"></i> Kembali</a><br><br></div>
