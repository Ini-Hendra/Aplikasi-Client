...
if (isset($_POST['textfield'])) {
  ...
  $MM_redirectLoginSuccess = "login_cek.php";
...
<br>
        <div class="w3-white w3-border">
        	<div class="w3-row w3-blue w3-padding-large">
            <div class="w3-center">
            	
           	  <div class="w3-small"><strong>SELAMAT DATANG DI SISTEM INFORMASI</strong></div>
                <div class="w3-large"><strong>ABSENSI KARYAWAN</strong></div>
                <div class="w3-center">PT. PROVIS</div>
            </div>
            </div>
  ...
  <hr>
  <button type="submit" class="w3-btn w3-block w3-blue"><i class="fa fa-sign-in fa-fw"></i> Masuk</button>
</form><br>
            </div>
        </div>
...
<div class="w3-center w3-tiny">Copyright @ 2020 <strong>Aplikasi Absensi</strong><br>
