...
$query_rsAbsensiHariIni = "SELECT * FROM tb_absensi ORDER BY nik ASC";
...
<div class="w3-container w3-light-gray">
   ...
   <div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i class="fa fa-book"></i> SEMUA DATA ABSENSI</strong></div>  
