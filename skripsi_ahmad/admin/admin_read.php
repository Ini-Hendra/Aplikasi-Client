...
$query_rsAdminRead = "SELECT * FROM tb_admin ORDER BY id_admin DESC";
...
<?php if ($totalRows_rsAdminRead > 0) { // Show if recordset not empty ?>
  <div class="w3-row">
 	<div class="w3-col l3" style="padding-right:4px;"><a style="margin-top:8px; height:36px;" class="w3-btn w3-block w3-green w3-small" href="admin_create.php"><i class="fa fa-plus fa-fw"></i> Tambah Admin</a></div>
    ...
    <div class="w3-col l6" style="padding-left:4px;"><div class="w3-border w3-border-yellow w3-pale-yellow w3-padding w3-small" style="margin-top:8px;">
        Total Admin<span class="w3-right"><?php echo $totalRows_rsAdminRead ?></span>
        </div></div>
</div>
  ...
  <table class="w3-table w3-striped w3-small w3-hoverable w3-bordered w3-border" id="admin" style="margin-top:8px;">
      ...
      <td class="w3-border-right w3-center">Uername</td>
    ...
    <?php do { ?>
      <tr class="admin">
        ...
        <td class="w3-border-right w3-center"><?php echo $row_rsAdminRead['username']; ?></td>
        
        <td class="w3-center"><a class="w3-tag w3-small w3-green" style="text-decoration:none" href="admin_update.php?id_admin=<?php echo $row_rsAdminRead['id_admin']; ?>">Ubah</a> <a class="w3-tag w3-small w3-red" style="text-decoration:none" href="admin_delete.php?id_admin=<?php echo $row_rsAdminRead['id_admin']; ?>" onClick="return confirm('Anda Yakin Ingin Menghapus?\n<?php echo $row_rsAdminRead['nama']; ?>')">Hapus</a></td>
      </tr>
