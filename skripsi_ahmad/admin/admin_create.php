...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tb_admin (id_admin, nama, username, password) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_koneksi, $koneksi);
$query_rsAdminCreate = sprintf("SELECT * FROM tb_admin WHERE id_admin = %s", GetSQLValueString($colname_rsAdminCreate, "int"));
...
<div class="w3-large w3-border-bottom" style="padding-bottom:8px;">Tambah Admin</div>
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
<div style="margin-top:8px;">
<input type="text" class="w3-input w3-border w3-small" required placeholder="Nama" name="nama" value="" size="32">
</div>

<div style="margin-top:8px;">
<input type="text" class="w3-input w3-border w3-small" required placeholder="Username" name="username" value="" size="32">
</div>
