...
$query_rsFabrikasi = "SELECT * FROM tb_file WHERE kategori='Spartpart' ORDER BY tgl_upload DESC";
...
<div class="w3-container w3-light-gray">
  ...
  <a href="<?php echo $logoutAction ?>" onClick="return confirm('Anda Yakin Ingin Keluar?')" style="text-decoration:none"><li><i class="fa fa-sign-out fa-fw"></i> Keluar</li></a>
                    ...
                    <div class="w3-col l9" style="padding-left:8px;">
                        ...
                        <div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i class="fa fa-book"></i> DATA ARSIP KATEGORI SPARTPART</strong></div>
                        <?php if ($totalRows_rsFabrikasi > 0) { // Show if recordset not empty ?>
  <input oninput="w3.filterHTML('#hendra8', '.item8', this.value)" placeholder="Pencarian Data" class="w3-input w3-border w3-small" style="outline:none; margin-top:8px;" autofocus>
  <div class="w3-small w3-text-red" style="margin-top:8px;">*Klik Untuk Melihat Secara Detail</div>
  <table class="w3-table w3-striped w3-small w3-hoverable w3-bordered w3-border" id="hendra8" style="margin-top:8px;">
