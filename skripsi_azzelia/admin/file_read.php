...
$query_rsFileRead = "SELECT * FROM tb_file ORDER BY tgl_upload DESC";
...
<div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i class="fa fa-book"></i> DATA ARSIP</strong></div>
  ...
  <table class="w3-table w3-striped w3-small w3-hoverable w3-bordered w3-border" id="hendra3" style="margin-top:8px;">
    ...
    <?php do { ?>
      <tr class="item3" style="cursor:pointer">
        ...
        <td onClick="document.getElementById('<?php echo $row_rsFileRead['id_file']; ?>').style.display='block'"><?php echo $row_rsFileRead['kategori']; ?></td>
        <td>
