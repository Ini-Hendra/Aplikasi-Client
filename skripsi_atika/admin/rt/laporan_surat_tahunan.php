...
if (isset($_POST['tahunNya'])) {
  $colname_rsSuratBulanan = $_POST['tahunNya'];
}
mysql_select_db($database_koneksi, $koneksi);
$query_rsSuratBulanan = sprintf("SELECT * FROM tb_surat WHERE YEAR(tanggal_input)=%s AND kategori_rt='$_SESSION[MM_Username]' ORDER BY tanggal_input DESC", GetSQLValueString($colname_rsSuratBulanan, "date"));
...
<div class="w3-container">
  <div class="w3-row">
    <div class="w3-center">
    	<div class="w3-large">LAPORAN DATA SURAT PENGANTAR RT <?php echo $_SESSION['MM_Username'] ?></div>
        <div class="w3-large">TAHUN <?php echo $colname_rsSuratBulanan ?></div>
