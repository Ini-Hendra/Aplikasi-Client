...
if ((isset($_GET['id_jenis'])) && ($_GET['id_jenis'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tb_jenis WHERE id_jenis=%s",
                       GetSQLValueString($_GET['id_jenis'], "int"));
...
mysql_select_db($database_koneksi, $koneksi);
$query_rsJenisDelete = "SELECT * FROM tb_jenis ORDER BY id_jenis ASC";
