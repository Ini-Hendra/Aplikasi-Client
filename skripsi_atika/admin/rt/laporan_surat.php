...
$query_rsSuratBulanan = sprintf("SELECT * FROM tb_surat WHERE MONTH(tanggal_input) = %s AND YEAR(tanggal_input)=%s AND kategori_rt='$_SESSION[MM_Username]' ORDER BY tanggal_input DESC", GetSQLValueString($colname_rsSuratBulanan, "date"),GetSQLValueString($colname_rsSuratBulanan2, "date"));
