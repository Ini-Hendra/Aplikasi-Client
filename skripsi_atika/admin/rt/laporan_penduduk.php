...
$query_rsPenduduk = "SELECT * FROM tb_warga WHERE kategori_rt='$_SESSION[MM_Username]' ORDER BY nama_lengkap ASC";
...
<div class="w3-container">
	<div class="w3-row">
    <div class="w3-center">
    	<div class="w3-large">LAPORAN DATA WARGA RT <?php echo $_SESSION['MM_Username'] ?> RW 03</div>
  ...
  <?php } // Show if recordset not empty ?>
    <?php if ($totalRows_rsPenduduk == 0) { // Show if recordset empty ?>
      <table class="w3-table w3-border" style="margin-top:8px;">
        <tr>
          <td class="w3-center">Tidak Ada Data Warga RT <?php echo $_SESSION['MM_Username'] ?></td>
        </tr>
      </table>
