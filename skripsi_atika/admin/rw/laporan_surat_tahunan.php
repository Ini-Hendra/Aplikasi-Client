...
$query_rsSuratBulanan = sprintf("SELECT * FROM tb_surat WHERE YEAR(tanggal_input)=%s ORDER BY tanggal_input DESC", GetSQLValueString($colname_rsSuratBulanan, "date"));
