...
<div class="w3-container">
	<div class="w3-row">
        ...
        <?php
		error_reporting(0);
	   $dataWarga = mysql_num_rows(mysql_query("SELECT * FROM tb_warga"));
	   ...
	   $dataKeluhan = mysql_num_rows(mysql_query("SELECT * FROM tb_keluhan"));
	   $dataPengurus = mysql_num_rows(mysql_query("SELECT * FROM tb_pengurus"));
	   $dataSurat = mysql_num_rows(mysql_query("SELECT * FROM tb_surat"));
        ...
        <div class="w3-row" style="margin-top:8px;">
        	<div class="w3-col l4" style="padding-right:3px;">
            	<ul class="w3-ul w3-border">
                	...
                	<li>Data Warga RW 03<span class="w3-right w3-tag"><?php echo $dataWarga ?></span></li>
