...
<span class="textfieldRequiredMsg"> Tidak Boleh Kosong.</span><span class="textfieldMinCharsMsg"> Minimal 16 Digit </span><span class="textfieldMaxCharsMsg"> Maksimal 16 Digit </span></span></div>
...
?>
		...
		<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "none", {minChars:16, maxChars:16, validateOn:["blur"]});
        </script>
