...
if (isset($_POST['textfield'])) {
  ...
  $LoginRS__query=sprintf("SELECT username, password FROM tb_warga WHERE username=%s AND password=%s",
...
<div class="w3-container">
	<div class="w3-row">
    	<div class="w3-col s12 m12 l12">
        	<div class="w3-center w3-jumbo" style="font-family:arial black"><strong>RW 03</strong></div>
        	<div class="w3-center w3-xlarge" style="margin-top:8px;"><strong>SISTEM INFORMASI</strong></div>
            <div class="w3-center w3-xlarge"><strong>LAYANAN KEPENDUDUKAN</strong></div>
            <div class="w3-center w3-medium">Kampung Periuk RW 03 Kota Tangerang</div><br>
<br>
<div class="w3-row">
        ...
        <div class="w3-center w3-small" style="margin-top:8px;">Lupa Password? <span onclick="document.getElementById('lupaKuy').style.display='block'" style="cursor:pointer" class="w3-text-blue">Klik Disini</span></div>
        <div id="lupaKuy" class="w3-modal">
  <div class="w3-modal-content">
    <div class="w3-container">
      <span onclick="document.getElementById('lupaKuy').style.display='none'"
      class="w3-button w3-display-topright">&times;</span>
      <p><i class="fa fa-search fa-fw"></i> Lupa Password</p>
      <p>
	  Jika Anda Lupa Password Login<br>
Silahkan Hubungi Ke Nomor <strong>08119950984</strong>
	  </p>
